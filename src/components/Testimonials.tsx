...
const Testimonials = () => {
  return (
    <div className='bg-slate-100 flex flex-col justify-center pb-16'>
      ...
      <div className='self-center'>
        <h2 className='text-center mb-5 text-lg text-slate-500 max-w-3xl'>Our software is so simple that people can't help but fall in love with it. Simplicity is easy when you just skip tons of mission-critical features.</h2>
      </div>
